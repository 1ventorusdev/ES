...
def maj():
    ...
    for user in users:
        ...
        fetch_file("https://raw.githubusercontent.com/1ventorus/emergency-system/main/version.txt", "version.txt")
        os.chdir(user)
        os.chdir("sys_apps")
        ...
        fetch_file("https://raw.githubusercontent.com/1ventorus/emergency-system/main/test/sys_apps/task_manager.py", "task_manager.py")
